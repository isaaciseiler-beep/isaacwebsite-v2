...
export default function RandomSpotButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-white px-4 text-sm font-semibold text-neutral-950 shadow-lg shadow-black/25 transition hover:bg-neutral-200 focus:outline-none focus:ring-2 focus:ring-white/80 disabled:cursor-not-allowed disabled:bg-white/15 disabled:text-white/45 disabled:shadow-none"
    >
