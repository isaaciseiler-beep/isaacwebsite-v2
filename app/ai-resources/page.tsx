...
type Item = {
  title: string;
  href: string;
  desc: string; // keep long descriptions
};
...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      {
        title: "AI K–12 Educators Group (OpenAI Academy)",
      ...
      },
      {
        ...
        desc: "Beginner-friendly course for building simple apps with the OpenAI API. Useful if you want to go beyond chat and learn the basics of calling models programmatically.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "Independent reporting on tech platforms, policy, and AI governance. A good source for understanding incentives, regulation, and how AI products shape public life.",
      },
      {
        title: "Ben’s Bites",
        href: "https://www.bensbites.com/",
        desc: "Daily AI news roundup with a strong focus on what’s shipping and what’s changing. Great for staying current without spending hours on social media.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Investigative reporting on power, labor, and politics behind the AI industry. Helpful for understanding supply chains, corporate incentives, and how AI reshapes institutions.",
      },
      {
    ...
    items: [
      {
        ...
        desc: "Technology news and analysis with strong AI coverage. A reliable place to track product launches, policy debates, and how AI shows up in everyday consumer tech.",
      },
    ],
  },
  {
...
export default function AiResourcesPage() {
  return (
    <div className="w-full overflow-x-hidden px-6 sm:px-10 pt-10 pb-20">
      <header className="max-w-[980px] mx-auto">
        <Link
          href="/"
