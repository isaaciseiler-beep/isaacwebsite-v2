  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Big-picture context on intelligence across biology, history, and computation. Useful for grounding AI hype through an interdisciplinary lens.",
      },
      {
        title: "The Alignment Problem",
        source: "Brian Christian",
        href: "https://www.amazon.com/Brief-History-Intelligence-Humans-Breakthroughs/dp/0063286343",
        desc: "History of modern AI that argues the real danger isn’t machines gone rogue, but our failure to encode unclear and conflicting human values.",
      },
      {
      ...
      },
      {
        ...
        desc: "A reporting-driven look at how AI is already used in hiring and management, showing how bias, surveillance, and junk models create real harm at work.",
      },
      {
        title: "Progressive Capitalism",
        source: "Ro Khanna",
        href: "https://www.amazon.com/Progressive-Capitalism-Make-Tech-Work/dp/198219186X",
        desc: "A policy argument for governing AI and tech growth so economic gains are shared broadly rather than captured by a narrow elite.",
      },
      {
        title: "AI 2041",
